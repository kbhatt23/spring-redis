...
public class JedisConfig {
	...
	// this is specifically with key as string and value as string
	@Bean
	...
	@Bean
	public RedisTemplate<String, Employee> redisTemplateEmployee(RedisConnectionFactory connectionFactory) {
